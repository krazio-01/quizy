                    ...
                    },
                    {
                        ...
                        value: `
                          ...
                          script-src 'self' 'unsafe-inline' 'unsafe-eval'
                            ...
                            https://js.payglocal.com https://*.stripe.com;
                          ...
                          connect-src 'self' https://res.cloudinary.com https://*.google.com https://*.googleapis.com https://www.google-analytics.com https://js.payglocal.com https://*.stripe.com;
                          object-src 'none';
                          base-uri 'self';
                          form-action 'self';
